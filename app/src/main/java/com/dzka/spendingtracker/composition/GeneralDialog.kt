...
@Composable
fun GeneralDialogWithTextField(
    onDismissRequest: (() -> Unit)? = null,
    properties: DialogProperties = DialogProperties(),
    ...
    Dialog(
        ...
        GeneralDialogSkeletonWithTextField(
            title = title,
            message = message,
...
@Composable
fun GeneralDialogSkeletonWithTextField(
    title: String,
    message: String? = null,
    positiveBtnText: String,
    onTextValueChange: (String) -> Unit = {},
    ...
    Box(Modifier.fillMaxSize()) {
        Card(
            ...
            Column(
                ...
                Column {
                    TextField(value = newTextValue(), onValueChange = onTextValueChange)
                }
                Spacer(modifier = Modifier.width(16.dp))
                Row {
                    Row(
